...
# update function
    def update(self):
        ...
        pose[0] = self.pose.position.x # atualiza x
        pose[0] = pose[0] + random.normal(0,0.002) # atualiza x
        self.get_logger().info (f'Predicao {pose[0]}')
    ...
    def run(self):
        ...
        while(rclpy.ok):
            ...
            if(self.laser[0]>3):
                ...
                self.get_logger().info (f'correcao {media_nova}')
